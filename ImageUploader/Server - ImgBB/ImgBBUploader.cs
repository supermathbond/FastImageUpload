...
{
    public class ImgBBUploader : IUploader
    {
        ...
        private void fetchDataFromServerAndFillClassFields()
        {
            ...
            {
                string siteCode = client.DownloadString("https://imgbb.com");
        ...
        private byte[] generateHttpMultipartRequestBuffer(string file, string boundary)
        {
            ...
            {                
                ...
                builder.Append(boundaryInContnet);
                builder.Append(string.Format(headerTemplate, "privacy", "undefined"));
                builder.Append(boundaryInContnet);
        ...
        {
            // Headers
            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create("https://imgbb.com/json");
        ...
        private string GetImageFromHTML(string htmlCode)
        {
            try
            {
                ...
                int start = htmlCode.IndexOf("\"image\":\"") + "\"image\":\"".Length;
