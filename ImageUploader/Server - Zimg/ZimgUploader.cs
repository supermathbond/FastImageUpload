...
{
    public class ZimgUploader : IUploader
    {
        ...
        private void fetchDataFromServerAndFillClassFields()
        {
            ...
            {
                string siteCode = client.DownloadString("https://zimg.se");
        ...
        {
            // Headers
            HttpWebRequest myRequest = (HttpWebRequest)WebRequest.Create("https://zimg.se/json");
            ...
            myRequest.Headers.Add("Cookie", _cookie);
            ...
            using (Stream requestStream = myRequest.GetRequestStream())
            {
                ...
                using (StreamReader reader = new StreamReader(webResponse.GetResponseStream()))
                {
                    ...
                    {
                        if (htmlCode.Contains("Duplicated upload"))
                            throw new Exception("Error while uploading file. Server does not allowed duplicates and file is already on server");
                        else
